...
class Window(QtWidgets.QMainWindow):
    ...
    def alert_pistol(self):
        ...
        mobile="8709237925"
        msg="P Detected in "+str(g)
        print("Message==",msg)
        payload = "sender_id=FSTSMS&message="+msg+"&language=english&route=p&numbers="+mobile
        headers = {'authorization':"e6sm9EyhpaFf3CZtqnVX4NvBQLPbATSIWkiOuxM8gJKYDjlzrwm0GBhDyAWPxIlqjrouK3pcHkCTvb5g",'Content-Type': "application/x-www-form-urlencoded",'Cache-Control': "no-cache",}
